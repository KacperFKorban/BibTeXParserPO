...
/**
 * Class containing information of a single mastersthesis
 */
public class Mastersthesis extends Entry {
  /**
   * Class Fields
   */
  protected static EntryType categoryType = EntryType.MASTERSTHESIS;
  ...
  static {
    ...
    required.put(FieldType.SCHOOL, new FieldTypeSingleton(FieldType.SCHOOL));
  ...
  /**
   * Constructs a mastersthesis with given key and fields
   *
   * @param quotationKey entry key
   * @param fields entry fields
   */
  public Mastersthesis(String quotationKey, Map<FieldType, String> fields) {
