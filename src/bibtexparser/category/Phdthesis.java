...
/**
 * Class containing information of a single phdthesis
 */
public class Phdthesis extends Entry {
  /**
   * Class Fields
   */
  protected static EntryType categoryType = EntryType.PHDTHESIS;
  ...
  /**
   * Constructs a phdthesis with given key and fields
   *
   * @param quotationKey entry key
   * @param fields entry fields
   */
  public Phdthesis(String quotationKey, Map<FieldType, String> fields) {
