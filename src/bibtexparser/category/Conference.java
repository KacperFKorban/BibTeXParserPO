...
/**
 * Class containing information of a single conference
 */
public class Conference extends Entry {
  /**
   * Class Fields
   */
  protected static EntryType categoryType = EntryType.CONFERENCE;
  ...
  /**
   * Constructs a conference with given key and fields
   *
   * @param quotationKey entry key
   * @param fields entry fields
   */
  public Conference(String quotationKey, Map<FieldType, String> fields) {
